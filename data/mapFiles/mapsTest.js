...
var QTDistanceSpinBoxNew;
var QTDistanceSpinBoxExist;
var QTLatLineEdit;
var QTLngLineEdit;
var QTMyRoutesTable;


var startLocation = {lat: 48.15494, lng: 11.56468};
...
function RouteMarkers() {
	...
	this.getRouteMarkersAsTxt = function() {
...
function MapRoute(aid) {
    ...
    this.createAndAddRouteMarker = function(posX, posY, markerText, isPosOnWidget) {   	
    	...
    	var iconFile = '../data/images/blue-dot.png'; 
    	if (markerText.indexOf("shit:") == 0) {
    		iconFile = '../data/images/shit.png';
    	}
	    ...
	    var infocontent = document.createElement("div");
      	...
      	//infocontent.setAttribute("style", "width: 80px; height: 25px");
      	infocontent.setAttribute("style", "width: 80px");
      	inforank.setAttribute("style", "float: left; background: #eee; font-weight: bold; padding: 2px; margin-right: 2px; margin-left: 0px");
    ...
    this.getRouteMarkersAsTxt = function() {
    	return routeMarkers.getRouteMarkersAsTxt();
    };
...
function initialize() {
	...
	new QWebChannel(qt.webChannelTransport, function (channel) {
	        QTDistanceSpinBoxNew 		= channel.objects.QTDistanceSpinBoxNew;
            QTDistanceSpinBoxExist 		= channel.objects.QTDistanceSpinBoxExist;
			QTMyRoutesTable 			= channel.objects.QTMyRoutesTable;
			QTLatLineEdit 				= channel.objects.QTLatLineEdit;
			QTLngLineEdit 				= channel.objects.QTLngLineEdit;
        });
